...
export const products: Product[] = [
  {
    ...
    image: "/images/vlskin_bodywash.PNG",
    keyBenefits: [
  ...
  {
    id: "3",
    name: "VLSartu Liquid Clay 1000ml",
    slug: "vlsartu-liquid-clay-1000ml",
    price: 29,
    shortDescription: "Consistent clay mix for sertu cleansing (1000ml)",
  ...
  {
    id: "4",
    name: "VLScent Natural Sanitizer 200ml",
    slug: "vlscent-natural-sanitizer-200ml",
    price: 25,
